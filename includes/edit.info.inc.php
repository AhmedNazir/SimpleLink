...
if ($_POST['actualcode'] != $_POST['givencode']) {
    header("location:edit.code.inc.php?link={$_POST['shorturl']}&error=wrongcode");
    exit();
}
...
<body>
    ...
    <form action="edit.update.inc.php" method="post" class="text-center mt-5">
        ...
        <!-- Expire : <input type="date" name="expire" value="<?php //echo $data['expire']
                                                                ?>"><br> -->
